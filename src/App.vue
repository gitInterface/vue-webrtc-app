<template>
  <div class="min-h-screen bg-gray-100 flex flex-col pt-6 pb-32 px-4 relative">
    ...
    <!-- 視訊畫面：手機直排 / 桌機橫排 -->
    <div class="flex flex-col md:flex-row justify-center gap-4 w-full max-w-6xl mx-auto">
      <div class="relative w-full md:w-1/2 h-[40vh] md:h-[60vh]">
        <video ref="localVideo" class="w-full aspect-video h-full bg-black rounded-xl shadow" autoplay playsinline
          muted></video>
      ...
      <div class="relative w-full md:w-1/2 h-[40vh] md:h-[60vh]">
        <video ref="remoteVideo" class="w-full aspect-video h-full bg-black rounded-xl shadow" autoplay
          playsinline></video>
